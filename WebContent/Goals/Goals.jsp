...
List<Goal> results = b.getGoal(a.getUID());

session.setAttribute("GoalList", results);
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/Health_first/Goals/GoalCatcher.jsp">
      <div class="modal-body">
       
        <label for="exampleInputEmail1">Goal</label>
    		<input name="desc" class="form-control" id="exampleInputEmail1" placeholder="ex. run">
                    ...
                    <div class="col">
                        <div class="card" style="margin-top: 50px;">
                            <div class="card-body">
                                ...
                                <c:forEach items="${GoalList}" var="product">
									 	
									 	<div class="card">
										  <div class="card-body">
										    	<h6>Goal: ${product.desc}</h6>
										    	<h6>Amount: ${product.value} ${product.messure}</h6>
										    	<button onclick = "window.location.href='http://localhost:8080/Health_first/Goals/DeleteGoalCatcher.jsp${url}&item=${product.goalID}&v=${product.value}&d=${product.desc}&m=${product.messure}'" type="button" class= "btn btn-outline-danger">Complete</button>
										  </div>
										</div>
